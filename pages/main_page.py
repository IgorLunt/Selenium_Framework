...
class Main_page(Base):
    ...
    about_page = "//a[@id = 'about_sidebar_link']"
    ...
    def get_about_page(self):
        return WebDriverWait(self.driver, 30).until(EC.element_to_be_clickable((By.XPATH, self.about_page)))
